...
using UnityEngine;
using Unity.Netcode;
using System.Security.Cryptography; // Namespace for Unity's Netcode for GameObjects
...
public class Player : NetworkBehaviour, IKitchenObjectParent {
    ...
    // Static property to hold the local player instance
    public static event EventHandler OnAnyPlayerSpawned;
    public static event EventHandler OnAnyPickedSomething;

    public static void ResetStaticData()
    {
        OnAnyPlayerSpawned = null; // Reset the static event to null
    }
    ...
    public override void OnNetworkSpawn()
    {
        if (IsOwner)
        {
            LocalInstance = this; // Set the local player instance
        }
        OnAnyPlayerSpawned?.Invoke(this, EventArgs.Empty); // Notify that a player has spawned
    }
